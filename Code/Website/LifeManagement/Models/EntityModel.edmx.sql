...
-- --------------------------------------------------
-- Date Created: 06/22/2017 10:58:07
...
IF OBJECT_ID(N'[dbo].[FK_UserForum]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Fora] DROP CONSTRAINT [FK_UserForum];
GO
IF OBJECT_ID(N'[dbo].[FK_CoachForum]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Fora] DROP CONSTRAINT [FK_CoachForum];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Fora]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Fora];
GO
...
-- Creating primary key on [Id] in table 'Fora'
ALTER TABLE [dbo].[Fora]
ADD CONSTRAINT [PK_Fora]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [UserId] in table 'Fora'
ALTER TABLE [dbo].[Fora]
...
-- Creating foreign key on [CoachId] in table 'Fora'
ALTER TABLE [dbo].[Fora]
