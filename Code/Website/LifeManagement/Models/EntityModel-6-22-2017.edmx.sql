...
-- --------------------------------------------------
-- Date Created: 06/22/2017 10:59:25
...
-- Creating primary key on [Id] in table 'Forum'
ALTER TABLE [dbo].[Forum]
ADD CONSTRAINT [PK_Forum]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [UserId] in table 'Forum'
ALTER TABLE [dbo].[Forum]
...
-- Creating foreign key on [CoachId] in table 'Forum'
ALTER TABLE [dbo].[Forum]
