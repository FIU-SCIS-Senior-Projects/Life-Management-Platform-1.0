...
-- --------------------------------------------------
-- Date Created: 06/22/2017 11:29:58
...
IF OBJECT_ID(N'[dbo].[FK_UserForum]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Forum] DROP CONSTRAINT [FK_UserForum];
GO
IF OBJECT_ID(N'[dbo].[FK_CoachForum]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Forum] DROP CONSTRAINT [FK_CoachForum];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Forum]', 'U') IS NOT NULL
